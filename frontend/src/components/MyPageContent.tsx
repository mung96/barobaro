...
export default function MyPageContent() {
  ...
  return (
    <>
        ...
        <div className="ml-5 mt-4 mb-4">
          ...
          <div className="flex flex-col items-start m-3">
            <Link href="/mypage/current/borrow">
              <button className="flex flex-row justify-center items-center my-1" type="button">
                <BorrowSVG />
        ...
        <div className="ml-5 mt-4 mb-4">
          ...
          <div className="flex flex-col items-start m-3">
            <Link href="/mypage/payment/main_account">
              <button type="button" className="flex flex-row justify-center items-center my-1">
                <MainAccountSVG />
                <p className="text-xs text-black-100">대표 계좌 설정</p>
              </button>
            </Link>
            <button type="button" className="flex flex-row justify-center items-center my-1" onClick={openBottomSheet}>
              <ConnectAccountSVG />
      ...
      <section>
        <ConnectAccountBottomSheet isOpen={isBottomSheetOpen} onClose={closeBottomSheet} height="400px">
