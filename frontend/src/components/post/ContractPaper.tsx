...
type Props = {
    ...
    height: string;
    onScrollToBottom: (isScrollToBottom: boolean) => void;
};
const ContractPaper = ({ context, height, onScrollToBottom }: Props) => {
    ...
    return <article style={{ height: height }} className='overflow-y-scroll px-4' ref={containerRef}>
